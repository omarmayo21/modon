...
export default function ProjectLeadForm({
  projectName = "Ras El Hekma, Egypt",
  redirectUrl = "/real-estate/ras-el-hekma/thank-you",
  ...
  return (
	...
	<form className="form contact" id="generic-project-form" action="/api/submit" method="POST">
		...
		<div className="form-group">
			...
			<input className="form-control" id="email" maxLength="80" name="email" size="20" type="email" autocomplete="off" />
		</div>
		
		<div className="form-group">
			<label htmlFor="00NVH000002y6iv">Country</label>
			<select id="00NVH000002y6iv" name="00NVH000002y6iv" title="Country" className="form-control select">
...
<option value="after 5 pm">after 5 pm</option>
		...
		<div className="form-group d-none">
			...
			<select className="form-control select" id="00NHp00000tWW0R" name="00NHp00000tWW0R"><option defaultValue={true} value={projectName}>{projectName}</option>
</select>
		</div>
